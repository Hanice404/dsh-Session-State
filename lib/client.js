...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
     ...
     */
    function foldCss(collapseThinking, collapseTools, collapseOther) {
      var parts = [];
      ...
      // 折叠除 Think/Edit/Bash/Read 之外的所有其他状态
      if (collapseOther) {
        parts.push(
    ...
    function apply(ctx) {
      ...
      var applyFold = function () {
        ...
        var collapseOther = v[COLLAPSE_OTHER] !== false;
        var css = foldCss(think, tools, collapseOther);
