...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ---------------------------------------------------------------------
    var BAR_CSS = [
      // Aligned with the composer card (input box) on both sides, 10px inset.
      '.dsm-bar{box-sizing:border-box;width:100%;max-width:var(--dsh-composer-card-max-width);margin:0 auto;padding:0 10px;display:flex;flex-direction:column;align-items:stretch;flex:none}',
